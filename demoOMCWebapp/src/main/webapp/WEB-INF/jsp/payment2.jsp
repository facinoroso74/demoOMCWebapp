...
<!-- 							</div> -->
							...
							<div class="tab2">
								<div class="pay_info">
									<form id="creditCardForm" action="paymentDone.html" method="post" class="creditly-card-form agileinfo_form">
...
<!-- 																<input class="security-code form-control" inputmode="numeric" type="text" name="securityCode" placeholder="&#149;&#149;&#149;"> -->
															</div>
														</div>
														<div class="clear"> </div>
													</div>
...
<!-- 														<input class="expiration-month-and-year form-control" type="text" name="expirationDate" placeholder="MM / YY"> -->
													</div>
												</div>

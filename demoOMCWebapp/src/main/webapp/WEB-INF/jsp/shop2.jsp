		...
		<div class="shop_inner_inf">
			...
			<div class="left-ads-display col-md-9">
				<div class="wrapper_top_shop">
					...
					<c:forEach items="${catalog.shoesArray}" var="shoes" varStatus="status">
						<div class="col-md-4 product-men">
							<div class="product-shoe-info shoe">
								<div class="men-pro-item">
									<div class="men-thumb-item">
										<img src="${shoes.imageId}" alt="">
									...
									<div class="item-info-product">
										<h4>
											<a href="single.html">${shoes.productName}</a>
										</h4>
										<div class="info-product-price">
											...
											<div class="shoe single-item hvr-outline-out">
												<form action="#" method="post">
													...
													<input type="hidden" name="shoe_item" value="${shoes.productName}">
													<input type="hidden" name="amount" value="${shoes.price}">
